      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Run comprehensive checks to identify and resolve issues with your ROSA CAPI/CAPA test
            environment
          </p>
        </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Don't see your issue here? Try <strong>"Tell me about my environment"</strong> for a
                broader overview, or check our <strong>troubleshooting documentation</strong>.
              </p>
            </div>
          </div>
        </div>
